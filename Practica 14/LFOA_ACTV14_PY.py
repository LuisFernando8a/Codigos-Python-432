#                                        Ensenada, Baja California a 24 de Noviembre del 2023#
#Actividad 14                                                                                #
#REALIZA LOS EJERCICIOS EN PYTHON USANDO LIBRERIA TKINTER                                    #
#Nombre:     Luis Fernando Ochoa Angulo                                                      #
#Matricula:  372746                                                                          #
#Programa:   calculadora usando tkinter                                                      #
#Nombre de la actividad: LFOA_ACT14_01_432_PY   
...
class Calculadora:
    def __init__(self, master):
        ...
        self.entrada = ttk.Entry(master, width=24, font=('Arial', 16), justify='right', style='TEntry')
